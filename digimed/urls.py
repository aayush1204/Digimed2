...
urlpatterns = [
    ...
    path('patient-appointment-cancel/<slug:p>', views.patient_appointments_cancel,name='patient-appointment-cancel'),
    ...
    path('admin_scheduled_appointment', views.admin_scheduled_appointment, name='admin_scheduled_appointment'),
    path('approve/<slug:pk>', views.approve, name='approve'),
